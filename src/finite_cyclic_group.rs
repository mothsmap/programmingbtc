...
impl FiniteCyclicGroup {
    pub fn from_secp256k1() -> Result<Self> {
        ...
        Ok(FiniteCyclicGroup {
            ...
            b: new_bigint(7),
            p: prime,
            g: Point::from(Some(gx), Some(gy), a, b).unwrap(),
    ...
    pub fn new(a: BigInt, b: BigInt, p: BigInt, x: BigInt, y: BigInt, n: BigInt) -> Result<Self> {
        ...
        Ok(FiniteCyclicGroup {
            ...
            b: b,
            p: p,
            g: Point::from(Some(x2), Some(y2), a2, b2).unwrap(),
            n: n,
        })
    }

    pub fn generate(&self, n: &BigInt) -> Point {
        let reduced_n = n.rem_euclid(&self.n);
        reduced_n * &self.g
    }

    pub fn generate_from_point(&self, n: &BigInt, x: &BigInt, y: &BigInt) -> Point {
        let reduced_n = n.rem_euclid(&self.n);
